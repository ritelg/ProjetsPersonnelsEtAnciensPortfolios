...
/***/ (function(module, exports) {
	...
	var Citations = {
		...
		getCitation: function getCitation(nb) {
			return this.citations[nb];
		}
	};

	var generateNumber = function generateNumber(myMin, myMax) {
		return Math.floor(Math.random() * (myMax - myMin + 1)) + myMin;
	};

	var newTweet = function newTweet(citation, autheur) {
		var url = "https://twitter.com/intent/tweet?text=" + encodeURI(citation + ' ' + autheur);
		window.open(url);
	};
	...
	document.addEventListener('DOMContentLoaded', function () {
		...
		var buttonGenerer = document.querySelector(".citations-button a");
		var buttonTweet = document.querySelector(".btn-tweeter");
		var citationText = document.querySelector(".citations-text-content");
		var citationTextAuthor = document.querySelector(".citations-text-author");

		// Au chargement de la page on ecrit une citation
		var citation = Citations.getCitation(generateNumber(1, 20));
